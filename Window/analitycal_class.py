...
class AnalitycalCalc:
    ...
    def __read_file(self):
        try:
            ...
            self.direct_current = arr_separator(direct_current)
            self.direct_voltage = arr_separator(direct_voltage)

            if self.is_inverse:
                self.reverse_current = arr_separator(reverse_current)
                self.reverse_voltage = arr_separator(reverse_voltage)
